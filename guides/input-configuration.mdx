...
<Note>
  Pin assignments for these inputs are hardware-specific. See the [hardware overview](/hardware/overview) for which physical pins carry PPM, ADC, UART, and CAN on the Delta.
</Note>
