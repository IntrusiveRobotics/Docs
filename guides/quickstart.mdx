...
<Info>
  The Delta runs **sensorless FOC only** — there is no encoder input on this board.
</Info>
...
The heatsinks have a small channel cut into the underside to clear the capacitors. Orient each sink so this channel sits over the capacitors; it will then sit flat against the board. If the sink rocks, sits proud, or bears on a capacitor, it is oriented wrong.
...
Source is at [github.com/vedderb/vesc_tool](https://github.com/vedderb/vesc_tool) (GPL v3). Only binaries from vesc-project.com are official releases.<br />\*_The Latest VESC TOOL Version is recommended_\*
