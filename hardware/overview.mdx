...
description: "Hardware reference for the Delta GaN ESC — connectors, pads, power terminals, and the 3D model."
...
<Card title="Download STEP model" icon="cube" href="/assets/delta-rev3_3-no-header.step">
  `delta-rev3_3-no-header.step` — 9.8 MB
</Card>

<Note>
  A STEP (ISO-10303-21) assembly exported from KiCad. It downloads rather than previewing in the browser — open it in your CAD tool.
</Note>
